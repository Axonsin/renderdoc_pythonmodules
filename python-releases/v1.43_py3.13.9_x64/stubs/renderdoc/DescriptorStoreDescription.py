...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD551C8590>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.DescriptorStoreDescription' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.DescriptorStoreDescription' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.DescriptorStoreDescription' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.DescriptorStoreDescription' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.DescriptorStoreDescription' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.DescriptorStoreDescription' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.DescriptorStoreDescription' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.DescriptorStoreDescription' objects>, 'resourceId': <attribute 'resourceId' of 'renderdoc.DescriptorStoreDescription' objects>, 'descriptorCount': <attribute 'descriptorCount' of 'renderdoc.DescriptorStoreDescription' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.DescriptorStoreDescription' objects>, 'descriptorByteSize': <attribute 'descriptorByteSize' of 'renderdoc.DescriptorStoreDescription' objects>, 'firstDescriptorOffset': <attribute 'firstDescriptorOffset' of 'renderdoc.DescriptorStoreDescription' objects>, '__doc__': 'A description of a descriptor store.'})"
