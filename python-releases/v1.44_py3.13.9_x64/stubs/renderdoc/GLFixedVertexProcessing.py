...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7DCEBA0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.GLFixedVertexProcessing' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.GLFixedVertexProcessing' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.GLFixedVertexProcessing' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.GLFixedVertexProcessing' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.GLFixedVertexProcessing' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.GLFixedVertexProcessing' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.GLFixedVertexProcessing' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.GLFixedVertexProcessing' objects>, 'defaultInnerLevel': <attribute 'defaultInnerLevel' of 'renderdoc.GLFixedVertexProcessing' objects>, 'defaultOuterLevel': <attribute 'defaultOuterLevel' of 'renderdoc.GLFixedVertexProcessing' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.GLFixedVertexProcessing' objects>, 'clipPlanes': <attribute 'clipPlanes' of 'renderdoc.GLFixedVertexProcessing' objects>, 'clipOriginLowerLeft': <attribute 'clipOriginLowerLeft' of 'renderdoc.GLFixedVertexProcessing' objects>, 'discard': <attribute 'discard' of 'renderdoc.GLFixedVertexProcessing' objects>, 'clipNegativeOneToOne': <attribute 'clipNegativeOneToOne' of 'renderdoc.GLFixedVertexProcessing' objects>, '__doc__': 'Describes the setup for fixed vertex processing operations.'})"
