...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7E029E0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.StencilFace' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.StencilFace' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.StencilFace' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.StencilFace' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.StencilFace' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.StencilFace' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.StencilFace' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.StencilFace' objects>, 'reference': <attribute 'reference' of 'renderdoc.StencilFace' objects>, 'function': <attribute 'function' of 'renderdoc.StencilFace' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.StencilFace' objects>, 'compareMask': <attribute 'compareMask' of 'renderdoc.StencilFace' objects>, 'writeMask': <attribute 'writeMask' of 'renderdoc.StencilFace' objects>, 'failOperation': <attribute 'failOperation' of 'renderdoc.StencilFace' objects>, 'depthFailOperation': <attribute 'depthFailOperation' of 'renderdoc.StencilFace' objects>, 'passOperation': <attribute 'passOperation' of 'renderdoc.StencilFace' objects>, '__doc__': 'Describes the details of a stencil operation.'})"
