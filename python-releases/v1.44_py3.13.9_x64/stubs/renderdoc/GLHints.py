...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7E3E5F0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.GLHints' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.GLHints' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.GLHints' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.GLHints' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.GLHints' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.GLHints' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.GLHints' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.GLHints' objects>, 'lineSmoothingEnabled': <attribute 'lineSmoothingEnabled' of 'renderdoc.GLHints' objects>, 'polySmoothingEnabled': <attribute 'polySmoothingEnabled' of 'renderdoc.GLHints' objects>, 'derivatives': <attribute 'derivatives' of 'renderdoc.GLHints' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.GLHints' objects>, 'textureCompression': <attribute 'textureCompression' of 'renderdoc.GLHints' objects>, 'lineSmoothing': <attribute 'lineSmoothing' of 'renderdoc.GLHints' objects>, 'polySmoothing': <attribute 'polySmoothing' of 'renderdoc.GLHints' objects>, '__doc__': 'Describes the current state of GL hints and smoothing.'})"
