...
class TargetControl(): # skipped bases: <class 'SwigPyObject'>
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7DF5300>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.TargetControl' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.TargetControl' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.TargetControl' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.TargetControl' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.TargetControl' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.TargetControl' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.TargetControl' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.TargetControl' objects>, 'Shutdown': <method 'Shutdown' of 'renderdoc.TargetControl' objects>, 'Connected': <method 'Connected' of 'renderdoc.TargetControl' objects>, 'GetTarget': <method 'GetTarget' of 'renderdoc.TargetControl' objects>, 'GetAPI': <method 'GetAPI' of 'renderdoc.TargetControl' objects>, 'GetPID': <method 'GetPID' of 'renderdoc.TargetControl' objects>, 'GetBusyClient': <method 'GetBusyClient' of 'renderdoc.TargetControl' objects>, 'TriggerCapture': <method 'TriggerCapture' of 'renderdoc.TargetControl' objects>, 'QueueCapture': <method 'QueueCapture' of 'renderdoc.TargetControl' objects>, 'CopyCapture': <method 'CopyCapture' of 'renderdoc.TargetControl' objects>, 'DeleteCapture': <method 'DeleteCapture' of 'renderdoc.TargetControl' objects>, 'ReceiveMessage': <method 'ReceiveMessage' of 'renderdoc.TargetControl' objects>, 'CycleActiveWindow': <method 'CycleActiveWindow' of 'renderdoc.TargetControl' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.TargetControl' objects>, '__doc__': '\\nA connection to a running application with RenderDoc injected, which allows limited\\ncontrol over the capture process as well as querying the current status.\\n\\n'})"
