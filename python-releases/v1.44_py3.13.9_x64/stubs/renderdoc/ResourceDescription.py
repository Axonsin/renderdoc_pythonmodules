...
class ResourceDescription(): # skipped bases: <class 'SwigPyObject'>
    ...
    def annotations(self) -> SDObject:
        """
An optional set of annotations associated with this resource, may be ``None`` if
...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7DD2830>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.ResourceDescription' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.ResourceDescription' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.ResourceDescription' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.ResourceDescription' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.ResourceDescription' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.ResourceDescription' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.ResourceDescription' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.ResourceDescription' objects>, 'SetCustomName': <method 'SetCustomName' of 'renderdoc.ResourceDescription' objects>, 'name': <attribute 'name' of 'renderdoc.ResourceDescription' objects>, 'resourceId': <attribute 'resourceId' of 'renderdoc.ResourceDescription' objects>, 'initialisationChunks': <attribute 'initialisationChunks' of 'renderdoc.ResourceDescription' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.ResourceDescription' objects>, 'derivedResources': <attribute 'derivedResources' of 'renderdoc.ResourceDescription' objects>, 'parentResources': <attribute 'parentResources' of 'renderdoc.ResourceDescription' objects>, 'annotations': <attribute 'annotations' of 'renderdoc.ResourceDescription' objects>, 'type': <attribute 'type' of 'renderdoc.ResourceDescription' objects>, 'autogeneratedName': <attribute 'autogeneratedName' of 'renderdoc.ResourceDescription' objects>, '__doc__': 'A description of any type of resource.'})"
