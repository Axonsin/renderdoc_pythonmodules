...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7E1CF20>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.ReplayOptions' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.ReplayOptions' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.ReplayOptions' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.ReplayOptions' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.ReplayOptions' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.ReplayOptions' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.ReplayOptions' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.ReplayOptions' objects>, 'forceGPUDeviceID': <attribute 'forceGPUDeviceID' of 'renderdoc.ReplayOptions' objects>, 'optimisation': <attribute 'optimisation' of 'renderdoc.ReplayOptions' objects>, 'apiValidation': <attribute 'apiValidation' of 'renderdoc.ReplayOptions' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.ReplayOptions' objects>, 'forceGPUVendor': <attribute 'forceGPUVendor' of 'renderdoc.ReplayOptions' objects>, 'forceGPUDriverName': <attribute 'forceGPUDriverName' of 'renderdoc.ReplayOptions' objects>, '__doc__': 'The options controlling how replay of a capture should be performed'})"
