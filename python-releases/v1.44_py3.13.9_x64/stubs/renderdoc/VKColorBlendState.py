...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7DE1690>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.VKColorBlendState' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.VKColorBlendState' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.VKColorBlendState' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.VKColorBlendState' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.VKColorBlendState' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.VKColorBlendState' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.VKColorBlendState' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.VKColorBlendState' objects>, 'blends': <attribute 'blends' of 'renderdoc.VKColorBlendState' objects>, 'blendFactor': <attribute 'blendFactor' of 'renderdoc.VKColorBlendState' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.VKColorBlendState' objects>, 'alphaToCoverageEnable': <attribute 'alphaToCoverageEnable' of 'renderdoc.VKColorBlendState' objects>, 'alphaToOneEnable': <attribute 'alphaToOneEnable' of 'renderdoc.VKColorBlendState' objects>, '__doc__': 'Describes the pipeline blending state.'})"
