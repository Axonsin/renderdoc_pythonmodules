...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7E434C0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.GLVertexAttribute' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.GLVertexAttribute' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.GLVertexAttribute' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.GLVertexAttribute' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.GLVertexAttribute' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.GLVertexAttribute' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.GLVertexAttribute' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.GLVertexAttribute' objects>, 'enabled': <attribute 'enabled' of 'renderdoc.GLVertexAttribute' objects>, 'genericValue': <attribute 'genericValue' of 'renderdoc.GLVertexAttribute' objects>, 'format': <attribute 'format' of 'renderdoc.GLVertexAttribute' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.GLVertexAttribute' objects>, 'boundShaderInput': <attribute 'boundShaderInput' of 'renderdoc.GLVertexAttribute' objects>, 'byteOffset': <attribute 'byteOffset' of 'renderdoc.GLVertexAttribute' objects>, 'vertexBufferSlot': <attribute 'vertexBufferSlot' of 'renderdoc.GLVertexAttribute' objects>, 'floatCast': <attribute 'floatCast' of 'renderdoc.GLVertexAttribute' objects>, '__doc__': '\\nDescribes the configuration for a single vertex attribute.\\n\\n.. note:: If old-style vertex attrib pointer setup was used for the vertex attributes then it will\\n  be decomposed into 1:1 attributes and buffers.\\n\\n'})"
