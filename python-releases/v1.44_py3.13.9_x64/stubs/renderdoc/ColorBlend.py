...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7E21930>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.ColorBlend' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.ColorBlend' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.ColorBlend' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.ColorBlend' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.ColorBlend' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.ColorBlend' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.ColorBlend' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.ColorBlend' objects>, 'colorBlend': <attribute 'colorBlend' of 'renderdoc.ColorBlend' objects>, 'enabled': <attribute 'enabled' of 'renderdoc.ColorBlend' objects>, 'logicOperationEnabled': <attribute 'logicOperationEnabled' of 'renderdoc.ColorBlend' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.ColorBlend' objects>, 'writeMask': <attribute 'writeMask' of 'renderdoc.ColorBlend' objects>, 'alphaBlend': <attribute 'alphaBlend' of 'renderdoc.ColorBlend' objects>, 'logicOperation': <attribute 'logicOperation' of 'renderdoc.ColorBlend' objects>, '__doc__': 'Describes the blend configuration for a given output target.'})"
