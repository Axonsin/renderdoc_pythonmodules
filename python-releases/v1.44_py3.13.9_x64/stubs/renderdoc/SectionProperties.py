...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7E4B030>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.SectionProperties' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.SectionProperties' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.SectionProperties' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.SectionProperties' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.SectionProperties' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.SectionProperties' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.SectionProperties' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.SectionProperties' objects>, 'name': <attribute 'name' of 'renderdoc.SectionProperties' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.SectionProperties' objects>, 'type': <attribute 'type' of 'renderdoc.SectionProperties' objects>, 'flags': <attribute 'flags' of 'renderdoc.SectionProperties' objects>, 'version': <attribute 'version' of 'renderdoc.SectionProperties' objects>, 'uncompressedSize': <attribute 'uncompressedSize' of 'renderdoc.SectionProperties' objects>, 'compressedSize': <attribute 'compressedSize' of 'renderdoc.SectionProperties' objects>, '__doc__': 'Properties of a section in a renderdoc capture file.'})"
