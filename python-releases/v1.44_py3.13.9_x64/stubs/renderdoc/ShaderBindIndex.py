...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7DE4BC0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.ShaderBindIndex' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.ShaderBindIndex' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.ShaderBindIndex' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.ShaderBindIndex' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.ShaderBindIndex' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.ShaderBindIndex' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.ShaderBindIndex' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.ShaderBindIndex' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.ShaderBindIndex' objects>, 'category': <attribute 'category' of 'renderdoc.ShaderBindIndex' objects>, 'index': <attribute 'index' of 'renderdoc.ShaderBindIndex' objects>, 'arrayElement': <attribute 'arrayElement' of 'renderdoc.ShaderBindIndex' objects>, '__doc__': '\\nReferences a particular individual binding element in a shader interface.\\n\\nThis is the shader interface side of a :class:`DescriptorAccess` and so can be compared to one to\\ncheck if an access refers to a given index or not.\\n\\nThe context of which shader reflection this index refers to must be provided to properly interpret\\nthis information, as it is relative to a particular :class:`ShaderReflection`.\\n\\n'})"
