...
"""
    ...
    def containsAnnotations(self) -> bool:
        """
Whether or not the capture contains any annotations.
...
"""
    ...
    @containsAnnotations.setter
    def containsAnnotations(self, value: bool):
        pass
...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'NoFrameNumber': 4294967295, 'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7DE52B0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.FrameDescription' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.FrameDescription' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.FrameDescription' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.FrameDescription' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.FrameDescription' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.FrameDescription' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.FrameDescription' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.FrameDescription' objects>, 'persistentSize': <attribute 'persistentSize' of 'renderdoc.FrameDescription' objects>, 'frameNumber': <attribute 'frameNumber' of 'renderdoc.FrameDescription' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.FrameDescription' objects>, 'captureTime': <attribute 'captureTime' of 'renderdoc.FrameDescription' objects>, 'fileOffset': <attribute 'fileOffset' of 'renderdoc.FrameDescription' objects>, 'stats': <attribute 'stats' of 'renderdoc.FrameDescription' objects>, 'containsAnnotations': <attribute 'containsAnnotations' of 'renderdoc.FrameDescription' objects>, 'uncompressedFileSize': <attribute 'uncompressedFileSize' of 'renderdoc.FrameDescription' objects>, 'compressedFileSize': <attribute 'compressedFileSize' of 'renderdoc.FrameDescription' objects>, 'initDataSize': <attribute 'initDataSize' of 'renderdoc.FrameDescription' objects>, 'debugMessages': <attribute 'debugMessages' of 'renderdoc.FrameDescription' objects>, '__doc__': '\\nContains frame-level global information\\n\\n.. data:: NoFrameNumber\\n\\n  No frame number is available.\\n\\n'})"
