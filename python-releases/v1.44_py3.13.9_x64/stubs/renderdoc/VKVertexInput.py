...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF7E42790>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.VKVertexInput' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.VKVertexInput' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.VKVertexInput' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.VKVertexInput' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.VKVertexInput' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.VKVertexInput' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.VKVertexInput' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.VKVertexInput' objects>, 'attributes': <attribute 'attributes' of 'renderdoc.VKVertexInput' objects>, 'vertexBuffers': <attribute 'vertexBuffers' of 'renderdoc.VKVertexInput' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.VKVertexInput' objects>, 'bindings': <attribute 'bindings' of 'renderdoc.VKVertexInput' objects>, '__doc__': 'Describes the fixed-function vertex input fetch setup.'})"
