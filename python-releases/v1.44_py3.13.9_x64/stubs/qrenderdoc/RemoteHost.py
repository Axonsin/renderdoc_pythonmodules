...
class RemoteHost(): # skipped bases: <class 'SwigPyObject'>
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF6F94E30>, '__hash__': <slot wrapper '__hash__' of 'qrenderdoc.RemoteHost' objects>, '__lt__': <slot wrapper '__lt__' of 'qrenderdoc.RemoteHost' objects>, '__le__': <slot wrapper '__le__' of 'qrenderdoc.RemoteHost' objects>, '__eq__': <slot wrapper '__eq__' of 'qrenderdoc.RemoteHost' objects>, '__ne__': <slot wrapper '__ne__' of 'qrenderdoc.RemoteHost' objects>, '__gt__': <slot wrapper '__gt__' of 'qrenderdoc.RemoteHost' objects>, '__ge__': <slot wrapper '__ge__' of 'qrenderdoc.RemoteHost' objects>, '__init__': <slot wrapper '__init__' of 'qrenderdoc.RemoteHost' objects>, 'CheckStatus': <method 'CheckStatus' of 'qrenderdoc.RemoteHost' objects>, 'Launch': <method 'Launch' of 'qrenderdoc.RemoteHost' objects>, 'IsServerRunning': <method 'IsServerRunning' of 'qrenderdoc.RemoteHost' objects>, 'IsConnected': <method 'IsConnected' of 'qrenderdoc.RemoteHost' objects>, 'IsBusy': <method 'IsBusy' of 'qrenderdoc.RemoteHost' objects>, 'IsVersionMismatch': <method 'IsVersionMismatch' of 'qrenderdoc.RemoteHost' objects>, 'VersionMismatchError': <method 'VersionMismatchError' of 'qrenderdoc.RemoteHost' objects>, 'Hostname': <method 'Hostname' of 'qrenderdoc.RemoteHost' objects>, 'FriendlyName': <method 'FriendlyName' of 'qrenderdoc.RemoteHost' objects>, 'RunCommand': <method 'RunCommand' of 'qrenderdoc.RemoteHost' objects>, 'SetRunCommand': <method 'SetRunCommand' of 'qrenderdoc.RemoteHost' objects>, 'LastCapturePath': <method 'LastCapturePath' of 'qrenderdoc.RemoteHost' objects>, 'SetLastCapturePath': <method 'SetLastCapturePath' of 'qrenderdoc.RemoteHost' objects>, 'Connect': <method 'Connect' of 'qrenderdoc.RemoteHost' objects>, 'Protocol': <method 'Protocol' of 'qrenderdoc.RemoteHost' objects>, 'Name': <method 'Name' of 'qrenderdoc.RemoteHost' objects>, 'IsLocalhost': <method 'IsLocalhost' of 'qrenderdoc.RemoteHost' objects>, 'IsValid': <method 'IsValid' of 'qrenderdoc.RemoteHost' objects>, '__dict__': <attribute '__dict__' of 'qrenderdoc.RemoteHost' objects>, '__doc__': 'A handle for interacting with a remote server on a given host.'})"
