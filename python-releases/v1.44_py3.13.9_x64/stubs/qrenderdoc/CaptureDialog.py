...
class CaptureDialog(): # skipped bases: <class 'SwigPyObject'>
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF6FA2EB0>, '__hash__': <slot wrapper '__hash__' of 'qrenderdoc.CaptureDialog' objects>, '__lt__': <slot wrapper '__lt__' of 'qrenderdoc.CaptureDialog' objects>, '__le__': <slot wrapper '__le__' of 'qrenderdoc.CaptureDialog' objects>, '__eq__': <slot wrapper '__eq__' of 'qrenderdoc.CaptureDialog' objects>, '__ne__': <slot wrapper '__ne__' of 'qrenderdoc.CaptureDialog' objects>, '__gt__': <slot wrapper '__gt__' of 'qrenderdoc.CaptureDialog' objects>, '__ge__': <slot wrapper '__ge__' of 'qrenderdoc.CaptureDialog' objects>, '__init__': <slot wrapper '__init__' of 'qrenderdoc.CaptureDialog' objects>, 'Widget': <method 'Widget' of 'qrenderdoc.CaptureDialog' objects>, 'IsInjectMode': <method 'IsInjectMode' of 'qrenderdoc.CaptureDialog' objects>, 'SetInjectMode': <method 'SetInjectMode' of 'qrenderdoc.CaptureDialog' objects>, 'SetExecutableFilename': <method 'SetExecutableFilename' of 'qrenderdoc.CaptureDialog' objects>, 'SetWorkingDirectory': <method 'SetWorkingDirectory' of 'qrenderdoc.CaptureDialog' objects>, 'SetCommandLine': <method 'SetCommandLine' of 'qrenderdoc.CaptureDialog' objects>, 'SetEnvironmentModifications': <method 'SetEnvironmentModifications' of 'qrenderdoc.CaptureDialog' objects>, 'SetSettings': <method 'SetSettings' of 'qrenderdoc.CaptureDialog' objects>, 'Settings': <method 'Settings' of 'qrenderdoc.CaptureDialog' objects>, 'TriggerCapture': <method 'TriggerCapture' of 'qrenderdoc.CaptureDialog' objects>, 'LoadSettings': <method 'LoadSettings' of 'qrenderdoc.CaptureDialog' objects>, 'SaveSettings': <method 'SaveSettings' of 'qrenderdoc.CaptureDialog' objects>, 'UpdateGlobalHook': <method 'UpdateGlobalHook' of 'qrenderdoc.CaptureDialog' objects>, 'UpdateRemoteHost': <method 'UpdateRemoteHost' of 'qrenderdoc.CaptureDialog' objects>, '__dict__': <attribute '__dict__' of 'qrenderdoc.CaptureDialog' objects>, '__doc__': '\\nThe executable capture window.\\n\\nThis window is retrieved by calling :meth:`CaptureContext.GetCaptureDialog`.\\n\\n'})"
