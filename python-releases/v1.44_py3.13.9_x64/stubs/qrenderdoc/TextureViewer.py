...
class TextureViewer(): # skipped bases: <class 'SwigPyObject'>
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFAF6FA0D20>, '__hash__': <slot wrapper '__hash__' of 'qrenderdoc.TextureViewer' objects>, '__lt__': <slot wrapper '__lt__' of 'qrenderdoc.TextureViewer' objects>, '__le__': <slot wrapper '__le__' of 'qrenderdoc.TextureViewer' objects>, '__eq__': <slot wrapper '__eq__' of 'qrenderdoc.TextureViewer' objects>, '__ne__': <slot wrapper '__ne__' of 'qrenderdoc.TextureViewer' objects>, '__gt__': <slot wrapper '__gt__' of 'qrenderdoc.TextureViewer' objects>, '__ge__': <slot wrapper '__ge__' of 'qrenderdoc.TextureViewer' objects>, '__init__': <slot wrapper '__init__' of 'qrenderdoc.TextureViewer' objects>, 'Widget': <method 'Widget' of 'qrenderdoc.TextureViewer' objects>, 'ViewTexture': <method 'ViewTexture' of 'qrenderdoc.TextureViewer' objects>, 'ViewFollowedResource': <method 'ViewFollowedResource' of 'qrenderdoc.TextureViewer' objects>, 'GetCurrentResource': <method 'GetCurrentResource' of 'qrenderdoc.TextureViewer' objects>, 'GetSelectedSubresource': <method 'GetSelectedSubresource' of 'qrenderdoc.TextureViewer' objects>, 'SetSelectedSubresource': <method 'SetSelectedSubresource' of 'qrenderdoc.TextureViewer' objects>, 'GotoLocation': <method 'GotoLocation' of 'qrenderdoc.TextureViewer' objects>, 'GetPickedLocation': <method 'GetPickedLocation' of 'qrenderdoc.TextureViewer' objects>, 'GetTextureOverlay': <method 'GetTextureOverlay' of 'qrenderdoc.TextureViewer' objects>, 'SetTextureOverlay': <method 'SetTextureOverlay' of 'qrenderdoc.TextureViewer' objects>, 'IsZoomAutoFit': <method 'IsZoomAutoFit' of 'qrenderdoc.TextureViewer' objects>, 'GetZoomLevel': <method 'GetZoomLevel' of 'qrenderdoc.TextureViewer' objects>, 'SetZoomLevel': <method 'SetZoomLevel' of 'qrenderdoc.TextureViewer' objects>, 'GetHistogramRange': <method 'GetHistogramRange' of 'qrenderdoc.TextureViewer' objects>, 'SetHistogramRange': <method 'SetHistogramRange' of 'qrenderdoc.TextureViewer' objects>, 'GetChannelVisibilityBits': <method 'GetChannelVisibilityBits' of 'qrenderdoc.TextureViewer' objects>, 'SetChannelVisibility': <method 'SetChannelVisibility' of 'qrenderdoc.TextureViewer' objects>, '__dict__': <attribute '__dict__' of 'qrenderdoc.TextureViewer' objects>, '__doc__': '\\nThe texture viewer window.\\n\\nThis window is retrieved by calling :meth:`CaptureContext.GetTextureViewer`.\\n\\n'})"
