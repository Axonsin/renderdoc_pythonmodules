...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BC65540>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.SDType' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.SDType' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.SDType' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.SDType' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.SDType' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.SDType' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.SDType' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.SDType' objects>, 'name': <attribute 'name' of 'renderdoc.SDType' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.SDType' objects>, 'byteSize': <attribute 'byteSize' of 'renderdoc.SDType' objects>, 'basetype': <attribute 'basetype' of 'renderdoc.SDType' objects>, 'flags': <attribute 'flags' of 'renderdoc.SDType' objects>, '__doc__': 'Details the name and properties of a structured type'})"
