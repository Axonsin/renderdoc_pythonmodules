...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD79DAB7C0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.CaptureFileFormat' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.CaptureFileFormat' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.CaptureFileFormat' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.CaptureFileFormat' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.CaptureFileFormat' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.CaptureFileFormat' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.CaptureFileFormat' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.CaptureFileFormat' objects>, 'name': <attribute 'name' of 'renderdoc.CaptureFileFormat' objects>, 'requiresBuffers': <attribute 'requiresBuffers' of 'renderdoc.CaptureFileFormat' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.CaptureFileFormat' objects>, 'description': <attribute 'description' of 'renderdoc.CaptureFileFormat' objects>, 'openSupported': <attribute 'openSupported' of 'renderdoc.CaptureFileFormat' objects>, 'convertSupported': <attribute 'convertSupported' of 'renderdoc.CaptureFileFormat' objects>, 'extension': <attribute 'extension' of 'renderdoc.CaptureFileFormat' objects>, '__doc__': 'The format for a capture file either supported to read from, or export to'})"
