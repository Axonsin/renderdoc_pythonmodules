...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BCC3F50>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.APIProperties' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.APIProperties' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.APIProperties' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.APIProperties' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.APIProperties' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.APIProperties' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.APIProperties' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.APIProperties' objects>, 'degraded': <attribute 'degraded' of 'renderdoc.APIProperties' objects>, 'rgpCapture': <attribute 'rgpCapture' of 'renderdoc.APIProperties' objects>, 'pixelHistory': <attribute 'pixelHistory' of 'renderdoc.APIProperties' objects>, 'remoteReplay': <attribute 'remoteReplay' of 'renderdoc.APIProperties' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.APIProperties' objects>, 'pipelineType': <attribute 'pipelineType' of 'renderdoc.APIProperties' objects>, 'shaderDebugging': <attribute 'shaderDebugging' of 'renderdoc.APIProperties' objects>, 'vendor': <attribute 'vendor' of 'renderdoc.APIProperties' objects>, 'localRenderer': <attribute 'localRenderer' of 'renderdoc.APIProperties' objects>, '__doc__': 'Gives some API-specific information about the capture.'})"
