...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BC7AE50>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.EventUsage' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.EventUsage' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.EventUsage' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.EventUsage' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.EventUsage' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.EventUsage' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.EventUsage' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.EventUsage' objects>, 'view': <attribute 'view' of 'renderdoc.EventUsage' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.EventUsage' objects>, 'eventId': <attribute 'eventId' of 'renderdoc.EventUsage' objects>, 'usage': <attribute 'usage' of 'renderdoc.EventUsage' objects>, '__doc__': 'Describes a particular use of a resource at a specific :data:`eventId <APIEvent.eventId>`.'})"
