...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BCE8E10>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.VKShader' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.VKShader' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.VKShader' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.VKShader' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.VKShader' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.VKShader' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.VKShader' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.VKShader' objects>, 'reflection': <attribute 'reflection' of 'renderdoc.VKShader' objects>, 'shaderObject': <attribute 'shaderObject' of 'renderdoc.VKShader' objects>, 'requiredSubgroupSize': <attribute 'requiredSubgroupSize' of 'renderdoc.VKShader' objects>, 'specializationData': <attribute 'specializationData' of 'renderdoc.VKShader' objects>, 'resourceId': <attribute 'resourceId' of 'renderdoc.VKShader' objects>, 'stage': <attribute 'stage' of 'renderdoc.VKShader' objects>, 'entryPoint': <attribute 'entryPoint' of 'renderdoc.VKShader' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.VKShader' objects>, 'pushConstantRangeByteOffset': <attribute 'pushConstantRangeByteOffset' of 'renderdoc.VKShader' objects>, 'pushConstantRangeByteSize': <attribute 'pushConstantRangeByteSize' of 'renderdoc.VKShader' objects>, 'specializationIds': <attribute 'specializationIds' of 'renderdoc.VKShader' objects>, '__doc__': 'Describes a Vulkan shader stage.'})"
