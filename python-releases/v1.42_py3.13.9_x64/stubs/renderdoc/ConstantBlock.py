...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BC84EF0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.ConstantBlock' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.ConstantBlock' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.ConstantBlock' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.ConstantBlock' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.ConstantBlock' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.ConstantBlock' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.ConstantBlock' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.ConstantBlock' objects>, 'bindArraySize': <attribute 'bindArraySize' of 'renderdoc.ConstantBlock' objects>, 'bufferBacked': <attribute 'bufferBacked' of 'renderdoc.ConstantBlock' objects>, 'name': <attribute 'name' of 'renderdoc.ConstantBlock' objects>, 'inlineDataBytes': <attribute 'inlineDataBytes' of 'renderdoc.ConstantBlock' objects>, 'variables': <attribute 'variables' of 'renderdoc.ConstantBlock' objects>, 'fixedBindNumber': <attribute 'fixedBindNumber' of 'renderdoc.ConstantBlock' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.ConstantBlock' objects>, 'compileConstants': <attribute 'compileConstants' of 'renderdoc.ConstantBlock' objects>, 'fixedBindSetOrSpace': <attribute 'fixedBindSetOrSpace' of 'renderdoc.ConstantBlock' objects>, 'byteSize': <attribute 'byteSize' of 'renderdoc.ConstantBlock' objects>, '__doc__': '\\nContains the information for a block of constant values. The values are not present,\\nonly the metadata about how the variables are stored in memory itself and their type/name\\ninformation.\\n\\n'})"
