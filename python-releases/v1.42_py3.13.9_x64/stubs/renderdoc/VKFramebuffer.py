...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BC9C6E0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.VKFramebuffer' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.VKFramebuffer' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.VKFramebuffer' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.VKFramebuffer' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.VKFramebuffer' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.VKFramebuffer' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.VKFramebuffer' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.VKFramebuffer' objects>, 'attachments': <attribute 'attachments' of 'renderdoc.VKFramebuffer' objects>, 'height': <attribute 'height' of 'renderdoc.VKFramebuffer' objects>, 'resourceId': <attribute 'resourceId' of 'renderdoc.VKFramebuffer' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.VKFramebuffer' objects>, 'width': <attribute 'width' of 'renderdoc.VKFramebuffer' objects>, 'layers': <attribute 'layers' of 'renderdoc.VKFramebuffer' objects>, '__doc__': 'Describes a framebuffer object and its attachments.'})"
