...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD79DF43C0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.Subresource' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.Subresource' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.Subresource' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.Subresource' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.Subresource' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.Subresource' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.Subresource' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.Subresource' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.Subresource' objects>, 'slice': <attribute 'slice' of 'renderdoc.Subresource' objects>, 'sample': <attribute 'sample' of 'renderdoc.Subresource' objects>, 'mip': <attribute 'mip' of 'renderdoc.Subresource' objects>, '__doc__': 'Specifies a subresource within a texture.'})"
