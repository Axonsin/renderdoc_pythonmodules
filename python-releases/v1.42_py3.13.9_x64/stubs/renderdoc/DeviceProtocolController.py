...
class DeviceProtocolController(): # skipped bases: <class 'SwigPyObject'>
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BC7A8C0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.DeviceProtocolController' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.DeviceProtocolController' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.DeviceProtocolController' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.DeviceProtocolController' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.DeviceProtocolController' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.DeviceProtocolController' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.DeviceProtocolController' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.DeviceProtocolController' objects>, 'GetProtocolName': <method 'GetProtocolName' of 'renderdoc.DeviceProtocolController' objects>, 'GetDevices': <method 'GetDevices' of 'renderdoc.DeviceProtocolController' objects>, 'GetFriendlyName': <method 'GetFriendlyName' of 'renderdoc.DeviceProtocolController' objects>, 'SupportsMultiplePrograms': <method 'SupportsMultiplePrograms' of 'renderdoc.DeviceProtocolController' objects>, 'IsSupported': <method 'IsSupported' of 'renderdoc.DeviceProtocolController' objects>, 'StartRemoteServer': <method 'StartRemoteServer' of 'renderdoc.DeviceProtocolController' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.DeviceProtocolController' objects>, '__doc__': 'An interface for enumerating and controlling remote devices.'})"
