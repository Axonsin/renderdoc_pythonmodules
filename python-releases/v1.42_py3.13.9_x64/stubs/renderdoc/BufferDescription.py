...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD79DF78A0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.BufferDescription' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.BufferDescription' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.BufferDescription' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.BufferDescription' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.BufferDescription' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.BufferDescription' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.BufferDescription' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.BufferDescription' objects>, 'creationFlags': <attribute 'creationFlags' of 'renderdoc.BufferDescription' objects>, 'length': <attribute 'length' of 'renderdoc.BufferDescription' objects>, 'resourceId': <attribute 'resourceId' of 'renderdoc.BufferDescription' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.BufferDescription' objects>, 'gpuAddress': <attribute 'gpuAddress' of 'renderdoc.BufferDescription' objects>, '__doc__': 'A description of a buffer resource.'})"
