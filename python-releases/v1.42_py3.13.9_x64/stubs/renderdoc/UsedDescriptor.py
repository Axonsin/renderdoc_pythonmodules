...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD79DDEE00>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.UsedDescriptor' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.UsedDescriptor' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.UsedDescriptor' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.UsedDescriptor' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.UsedDescriptor' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.UsedDescriptor' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.UsedDescriptor' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.UsedDescriptor' objects>, 'descriptor': <attribute 'descriptor' of 'renderdoc.UsedDescriptor' objects>, 'sampler': <attribute 'sampler' of 'renderdoc.UsedDescriptor' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.UsedDescriptor' objects>, 'access': <attribute 'access' of 'renderdoc.UsedDescriptor' objects>, '__doc__': '\\nCombined information about a single descriptor that has been used, both the information\\nabout its access and its contents.\\n\\nThis is a helper struct for the common pipeline state abstraction to trade off simplicity of access\\nagainst optimal access.\\n\\n'})"
