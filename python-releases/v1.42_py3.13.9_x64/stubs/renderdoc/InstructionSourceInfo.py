...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD79E124A0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.InstructionSourceInfo' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.InstructionSourceInfo' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.InstructionSourceInfo' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.InstructionSourceInfo' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.InstructionSourceInfo' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.InstructionSourceInfo' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.InstructionSourceInfo' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.InstructionSourceInfo' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.InstructionSourceInfo' objects>, 'lineInfo': <attribute 'lineInfo' of 'renderdoc.InstructionSourceInfo' objects>, 'sourceVars': <attribute 'sourceVars' of 'renderdoc.InstructionSourceInfo' objects>, 'instruction': <attribute 'instruction' of 'renderdoc.InstructionSourceInfo' objects>, '__doc__': '\\nGives per-instruction source code mapping information, including what line(s) correspond\\nto this instruction and which source variables exist\\n\\n'})"
