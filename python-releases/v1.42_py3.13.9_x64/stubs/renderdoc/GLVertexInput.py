...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BC95FA0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.GLVertexInput' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.GLVertexInput' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.GLVertexInput' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.GLVertexInput' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.GLVertexInput' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.GLVertexInput' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.GLVertexInput' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.GLVertexInput' objects>, 'attributes': <attribute 'attributes' of 'renderdoc.GLVertexInput' objects>, 'indexBuffer': <attribute 'indexBuffer' of 'renderdoc.GLVertexInput' objects>, 'primitiveRestart': <attribute 'primitiveRestart' of 'renderdoc.GLVertexInput' objects>, 'vertexBuffers': <attribute 'vertexBuffers' of 'renderdoc.GLVertexInput' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.GLVertexInput' objects>, 'indexByteStride': <attribute 'indexByteStride' of 'renderdoc.GLVertexInput' objects>, 'topology': <attribute 'topology' of 'renderdoc.GLVertexInput' objects>, 'provokingVertexLast': <attribute 'provokingVertexLast' of 'renderdoc.GLVertexInput' objects>, 'restartIndex': <attribute 'restartIndex' of 'renderdoc.GLVertexInput' objects>, 'vertexArrayObject': <attribute 'vertexArrayObject' of 'renderdoc.GLVertexInput' objects>, '__doc__': 'Describes the setup for fixed-function vertex input fetch.'})"
