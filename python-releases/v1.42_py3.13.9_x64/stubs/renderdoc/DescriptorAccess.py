...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'NoShaderBinding': 65535, 'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BCA3CF0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.DescriptorAccess' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.DescriptorAccess' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.DescriptorAccess' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.DescriptorAccess' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.DescriptorAccess' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.DescriptorAccess' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.DescriptorAccess' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.DescriptorAccess' objects>, 'stage': <attribute 'stage' of 'renderdoc.DescriptorAccess' objects>, 'descriptorStore': <attribute 'descriptorStore' of 'renderdoc.DescriptorAccess' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.DescriptorAccess' objects>, 'byteOffset': <attribute 'byteOffset' of 'renderdoc.DescriptorAccess' objects>, 'type': <attribute 'type' of 'renderdoc.DescriptorAccess' objects>, 'byteSize': <attribute 'byteSize' of 'renderdoc.DescriptorAccess' objects>, 'index': <attribute 'index' of 'renderdoc.DescriptorAccess' objects>, 'staticallyUnused': <attribute 'staticallyUnused' of 'renderdoc.DescriptorAccess' objects>, 'arrayElement': <attribute 'arrayElement' of 'renderdoc.DescriptorAccess' objects>, '__doc__': '\\nThe details of a single accessed descriptor as fetched by a shader and which descriptor\\nin the descriptor store was fetched.\\n\\nThis may be a somewhat conservative access, reported as possible but not actually executed on the\\nGPU itself.\\n\\n.. data:: NoShaderBinding\\n\\n  No shader binding corresponds to this descriptor access, it happened directly without going\\n  through any kind of binding.\\n\\n'})"
