...
class Camera(): # skipped bases: <class 'SwigPyObject'>
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD79D9D940>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.Camera' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.Camera' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.Camera' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.Camera' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.Camera' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.Camera' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.Camera' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.Camera' objects>, 'Shutdown': <method 'Shutdown' of 'renderdoc.Camera' objects>, 'SetNearFar': <method 'SetNearFar' of 'renderdoc.Camera' objects>, 'SetPosition': <method 'SetPosition' of 'renderdoc.Camera' objects>, 'SetFPSRotation': <method 'SetFPSRotation' of 'renderdoc.Camera' objects>, 'SetArcballDistance': <method 'SetArcballDistance' of 'renderdoc.Camera' objects>, 'ResetArcball': <method 'ResetArcball' of 'renderdoc.Camera' objects>, 'RotateArcball': <method 'RotateArcball' of 'renderdoc.Camera' objects>, 'GetPosition': <method 'GetPosition' of 'renderdoc.Camera' objects>, 'GetForward': <method 'GetForward' of 'renderdoc.Camera' objects>, 'GetRight': <method 'GetRight' of 'renderdoc.Camera' objects>, 'GetUp': <method 'GetUp' of 'renderdoc.Camera' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.Camera' objects>, '__doc__': '\\nA handle to a camera controller, used for user interaction and controlling a view of a\\n3D scene.\\n\\n'})"
