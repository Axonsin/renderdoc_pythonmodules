...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BCE76B0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, 'flags': <attribute 'flags' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, 'myJSONs': <attribute 'myJSONs' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, 'otherJSONs': <attribute 'otherJSONs' of 'renderdoc.VulkanLayerRegistrationInfo' objects>, '__doc__': 'INTERNAL: Information about vulkan layer registration'})"
