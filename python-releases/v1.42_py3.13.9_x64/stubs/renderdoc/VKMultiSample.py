...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD79DF7470>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.VKMultiSample' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.VKMultiSample' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.VKMultiSample' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.VKMultiSample' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.VKMultiSample' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.VKMultiSample' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.VKMultiSample' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.VKMultiSample' objects>, 'minSampleShading': <attribute 'minSampleShading' of 'renderdoc.VKMultiSample' objects>, 'rasterSamples': <attribute 'rasterSamples' of 'renderdoc.VKMultiSample' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.VKMultiSample' objects>, 'sampleShadingEnable': <attribute 'sampleShadingEnable' of 'renderdoc.VKMultiSample' objects>, 'sampleMask': <attribute 'sampleMask' of 'renderdoc.VKMultiSample' objects>, 'sampleLocations': <attribute 'sampleLocations' of 'renderdoc.VKMultiSample' objects>, '__doc__': 'Describes the multisampling state in the pipeline.'})"
