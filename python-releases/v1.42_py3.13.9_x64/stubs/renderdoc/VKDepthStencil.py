...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD79DA99B0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.VKDepthStencil' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.VKDepthStencil' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.VKDepthStencil' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.VKDepthStencil' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.VKDepthStencil' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.VKDepthStencil' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.VKDepthStencil' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.VKDepthStencil' objects>, 'frontFace': <attribute 'frontFace' of 'renderdoc.VKDepthStencil' objects>, 'backFace': <attribute 'backFace' of 'renderdoc.VKDepthStencil' objects>, 'depthFunction': <attribute 'depthFunction' of 'renderdoc.VKDepthStencil' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.VKDepthStencil' objects>, 'depthWriteEnable': <attribute 'depthWriteEnable' of 'renderdoc.VKDepthStencil' objects>, 'depthBoundsEnable': <attribute 'depthBoundsEnable' of 'renderdoc.VKDepthStencil' objects>, 'minDepthBounds': <attribute 'minDepthBounds' of 'renderdoc.VKDepthStencil' objects>, 'maxDepthBounds': <attribute 'maxDepthBounds' of 'renderdoc.VKDepthStencil' objects>, 'depthTestEnable': <attribute 'depthTestEnable' of 'renderdoc.VKDepthStencil' objects>, 'stencilTestEnable': <attribute 'stencilTestEnable' of 'renderdoc.VKDepthStencil' objects>, '__doc__': 'Describes the pipeline depth-stencil state.'})"
