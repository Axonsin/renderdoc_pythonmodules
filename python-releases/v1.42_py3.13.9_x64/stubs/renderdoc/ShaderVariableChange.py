...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85BCBA920>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.ShaderVariableChange' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.ShaderVariableChange' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.ShaderVariableChange' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.ShaderVariableChange' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.ShaderVariableChange' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.ShaderVariableChange' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.ShaderVariableChange' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.ShaderVariableChange' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.ShaderVariableChange' objects>, 'after': <attribute 'after' of 'renderdoc.ShaderVariableChange' objects>, 'before': <attribute 'before' of 'renderdoc.ShaderVariableChange' objects>, '__doc__': 'This stores the before and after state of a :class:`ShaderVariable`.'})"
