...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD796186E0>, '__hash__': <slot wrapper '__hash__' of 'qrenderdoc.ExtensionMetadata' objects>, '__lt__': <slot wrapper '__lt__' of 'qrenderdoc.ExtensionMetadata' objects>, '__le__': <slot wrapper '__le__' of 'qrenderdoc.ExtensionMetadata' objects>, '__eq__': <slot wrapper '__eq__' of 'qrenderdoc.ExtensionMetadata' objects>, '__ne__': <slot wrapper '__ne__' of 'qrenderdoc.ExtensionMetadata' objects>, '__gt__': <slot wrapper '__gt__' of 'qrenderdoc.ExtensionMetadata' objects>, '__ge__': <slot wrapper '__ge__' of 'qrenderdoc.ExtensionMetadata' objects>, '__init__': <slot wrapper '__init__' of 'qrenderdoc.ExtensionMetadata' objects>, 'package': <attribute 'package' of 'qrenderdoc.ExtensionMetadata' objects>, 'version': <attribute 'version' of 'qrenderdoc.ExtensionMetadata' objects>, 'description': <attribute 'description' of 'qrenderdoc.ExtensionMetadata' objects>, 'extensionAPI': <attribute 'extensionAPI' of 'qrenderdoc.ExtensionMetadata' objects>, '__dict__': <attribute '__dict__' of 'qrenderdoc.ExtensionMetadata' objects>, 'author': <attribute 'author' of 'qrenderdoc.ExtensionMetadata' objects>, 'extensionURL': <attribute 'extensionURL' of 'qrenderdoc.ExtensionMetadata' objects>, 'name': <attribute 'name' of 'qrenderdoc.ExtensionMetadata' objects>, 'filePath': <attribute 'filePath' of 'qrenderdoc.ExtensionMetadata' objects>, '__doc__': 'The metadata for an extension.'})"
