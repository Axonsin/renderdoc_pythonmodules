...
class MainWindow(): # skipped bases: <class 'SwigPyObject'>
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD7961CB30>, '__hash__': <slot wrapper '__hash__' of 'qrenderdoc.MainWindow' objects>, '__lt__': <slot wrapper '__lt__' of 'qrenderdoc.MainWindow' objects>, '__le__': <slot wrapper '__le__' of 'qrenderdoc.MainWindow' objects>, '__eq__': <slot wrapper '__eq__' of 'qrenderdoc.MainWindow' objects>, '__ne__': <slot wrapper '__ne__' of 'qrenderdoc.MainWindow' objects>, '__gt__': <slot wrapper '__gt__' of 'qrenderdoc.MainWindow' objects>, '__ge__': <slot wrapper '__ge__' of 'qrenderdoc.MainWindow' objects>, '__init__': <slot wrapper '__init__' of 'qrenderdoc.MainWindow' objects>, 'Widget': <method 'Widget' of 'qrenderdoc.MainWindow' objects>, 'RegisterShortcut': <method 'RegisterShortcut' of 'qrenderdoc.MainWindow' objects>, 'UnregisterShortcut': <method 'UnregisterShortcut' of 'qrenderdoc.MainWindow' objects>, 'BringToFront': <method 'BringToFront' of 'qrenderdoc.MainWindow' objects>, '__dict__': <attribute '__dict__' of 'qrenderdoc.MainWindow' objects>, '__doc__': '\\nThe main parent window of the application.\\n\\nThis window is retrieved by calling :meth:`CaptureContext.GetMainWindow`.\\n\\n.. function:: ShortcutCallback(QWidget focusWidget)\\n\\n  Not a member function - the signature for any ``ShortcutCallback`` callbacks.\\n\\n  :param QWidget focusWidget: The widget with focus at the time this shortcut was detected. May be\\n     ``None``.\\n\\n'})"
