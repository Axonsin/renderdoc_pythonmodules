...
class PipelineStateViewer(): # skipped bases: <class 'SwigPyObject'>
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFD7961EED0>, '__hash__': <slot wrapper '__hash__' of 'qrenderdoc.PipelineStateViewer' objects>, '__lt__': <slot wrapper '__lt__' of 'qrenderdoc.PipelineStateViewer' objects>, '__le__': <slot wrapper '__le__' of 'qrenderdoc.PipelineStateViewer' objects>, '__eq__': <slot wrapper '__eq__' of 'qrenderdoc.PipelineStateViewer' objects>, '__ne__': <slot wrapper '__ne__' of 'qrenderdoc.PipelineStateViewer' objects>, '__gt__': <slot wrapper '__gt__' of 'qrenderdoc.PipelineStateViewer' objects>, '__ge__': <slot wrapper '__ge__' of 'qrenderdoc.PipelineStateViewer' objects>, '__init__': <slot wrapper '__init__' of 'qrenderdoc.PipelineStateViewer' objects>, 'Widget': <method 'Widget' of 'qrenderdoc.PipelineStateViewer' objects>, 'SaveShaderFile': <method 'SaveShaderFile' of 'qrenderdoc.PipelineStateViewer' objects>, 'SelectPipelineStage': <method 'SelectPipelineStage' of 'qrenderdoc.PipelineStateViewer' objects>, '__dict__': <attribute '__dict__' of 'qrenderdoc.PipelineStateViewer' objects>, '__doc__': '\\nThe pipeline state viewer window.\\n\\nThis window is retrieved by calling :meth:`CaptureContext.GetPipelineViewer`.\\n\\n'})"
