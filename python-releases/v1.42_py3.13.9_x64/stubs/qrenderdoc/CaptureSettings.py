...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FF85B619690>, '__hash__': <slot wrapper '__hash__' of 'qrenderdoc.CaptureSettings' objects>, '__lt__': <slot wrapper '__lt__' of 'qrenderdoc.CaptureSettings' objects>, '__le__': <slot wrapper '__le__' of 'qrenderdoc.CaptureSettings' objects>, '__eq__': <slot wrapper '__eq__' of 'qrenderdoc.CaptureSettings' objects>, '__ne__': <slot wrapper '__ne__' of 'qrenderdoc.CaptureSettings' objects>, '__gt__': <slot wrapper '__gt__' of 'qrenderdoc.CaptureSettings' objects>, '__ge__': <slot wrapper '__ge__' of 'qrenderdoc.CaptureSettings' objects>, '__init__': <slot wrapper '__init__' of 'qrenderdoc.CaptureSettings' objects>, 'numQueuedFrames': <attribute 'numQueuedFrames' of 'qrenderdoc.CaptureSettings' objects>, 'environment': <attribute 'environment' of 'qrenderdoc.CaptureSettings' objects>, '__dict__': <attribute '__dict__' of 'qrenderdoc.CaptureSettings' objects>, 'executable': <attribute 'executable' of 'qrenderdoc.CaptureSettings' objects>, 'commandLine': <attribute 'commandLine' of 'qrenderdoc.CaptureSettings' objects>, 'inject': <attribute 'inject' of 'qrenderdoc.CaptureSettings' objects>, 'queuedFrameCap': <attribute 'queuedFrameCap' of 'qrenderdoc.CaptureSettings' objects>, 'options': <attribute 'options' of 'qrenderdoc.CaptureSettings' objects>, 'autoStart': <attribute 'autoStart' of 'qrenderdoc.CaptureSettings' objects>, 'workingDir': <attribute 'workingDir' of 'qrenderdoc.CaptureSettings' objects>, '__doc__': 'Contains all of the settings that control how to capture an executable.'})"
